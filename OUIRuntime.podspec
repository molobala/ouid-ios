Pod::Spec.new do |s|
  ...
  s.source           = {
    :http   => 'https://github.com/molobala/ouid-ios/releases/download/0.0.6/OUIRuntime.xcframework.zip',
    :sha256 => 'e4a37eb8e8bf12a5567b31b653206989613280ed490bdd82e48d94f4967df334'
  }
