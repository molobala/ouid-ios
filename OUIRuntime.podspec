Pod::Spec.new do |s|
  ...
  s.source           = {
    :http   => 'https://github.com/molobala/ouid-ios/releases/download/0.0.1/OUIRuntime.xcframework.zip',
    :sha256 => 'a94e6f065bec064a55336b722659e5a02fbef023c053e428e7cabf70102eb6ed'
  }
