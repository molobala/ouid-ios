Pod::Spec.new do |s|
  ...
  s.source           = {
    :http   => 'https://github.com/molobala/ouid-ios/releases/download/0.1.2/OUIRuntime.xcframework.zip',
    :sha256 => '46def6e4ee5da956e4b6d3539fc930b1de7efdce2f5ff2827bae9bb30ee1906f'
  }
