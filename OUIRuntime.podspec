Pod::Spec.new do |s|
  ...
  s.source           = {
    :http   => 'https://github.com/molobala/ouid-ios/releases/download/0.1.3/OUIRuntime.xcframework.zip',
    :sha256 => 'e0e9cfc671d503fb76083cdae12cb98eaa1b8f76db8411c0a5398a3f012df6d7'
  }
